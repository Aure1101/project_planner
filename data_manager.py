...
def create_act(act, nombre, responsable, tiempo_esperado, tiempo_optimista, tiempo_mas_probable, tiempo_pesimista, tiempo_acelerado, fecha_inicio, costo_esperado, costo_acelerado):
    print(type(act))
